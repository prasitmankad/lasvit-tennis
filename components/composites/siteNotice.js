      ...
      <div className="max-w-7xl mx-auto py-3 px-3 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between flex-wrap">
          <div className="w-0 flex-1 flex items-center">
            <span
              className={
                "flex p-2 rounded-lg bg-" + props.sectionData.backgroundColor.title
              }
            >
              <SpeakerphoneIcon
            ...
            <p className="ml-3 font-medium text-white truncate">
              <span className="md:hidden">{props.sectionData.messageText}</span>
              <span className="hidden md:inline">{props.sectionData.messageText}</span>
            </p>
          </div>
