...
function FooterSection(props) {
  console.log("props into FooterSection ->  ", props);
        ...
        <div className="mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
          <div className="xl:grid xl:grid-cols-3 xl:gap-8">
            <div className="space-y-8 xl:col-span-1">
              ...
              <p className="text-gray-500 text-base">
                {data.businessInfo.contact.streetNo}{" "}
                {data.businessInfo.contact.street}
                <br />
                {data.businessInfo.contact.city},{" "}
                {data.businessInfo.contact.country}{" "}
                {data.businessInfo.contact.zip}
              </p>
              <div className="flex space-x-6">
                <a
                  href={data.siteSettings.facebook}
            ...
            <div className="mt-12 py-14 grid grid-cols-2 gap-8 xl:mt-0 xl:col-span-2">
              <div className="md:grid md:grid-cols-2 md:gap-8">
                <div>
                  <h3 className="text-sm font-semibold text-gray-400 tracking-wider uppercase">
                    {/* {data.footer.column1.heading} */}
                  </h3>
                  {/* Repeating Columns */}
          ...
          <div className="border-t border-gray-200 pt-8 lg:flex lg:items-center lg:justify-between xl:mt-0">
            <div>
              <h3 className="text-sm font-semibold text-gray-400 tracking-wider uppercase">
                {data.footer.signup.heading}
              </h3>
              <p className="mt-2 text-base text-gray-500">
                {data.footer.signup.message}
              </p>
            </div>
            {/* TODO: Integrate MailerLite API for newsletter signups */}
          ...
          <div className="mt-12 border-t border-gray-200 pt-8">
            <p className="text-base text-gray-400 xl:text-center">
              © 2021 {data.businessInfo.title}. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
